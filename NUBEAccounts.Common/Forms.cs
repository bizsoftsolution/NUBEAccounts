...
namespace NUBEAccounts.Common
{
    public static class Forms
    {
        public static readonly string frmFundMaster = "NUBEAccounts.Pl.frm.Master.frmFundMaster",
                                        ...
                                        frmActivityReport = "NUBEAccounts.Pl.frm.Reports.frmActivityReport",
                                        frmGeneralLedger = "NUBEAccounts.Pl.frm.Reports.frmGeneralLedger",
                                        frmPaymentAndReceipt = "NUBEAccounts.Pl.frm.Reports.frmPaymentAndReceipt",
                                        VoucherReport = "NUBEAccounts.Pl.frm.Reports.VoucherReport",
